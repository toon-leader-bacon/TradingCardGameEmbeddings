...
from src.data_refinement.seventeenlands.v2.replay_data_metrics.average_turn_cast_metric import (
...
class TestAccumulateAndFinalize:
    def test_computes_average_turn_cast(self, tmp_path: Path) -> None:
        binder = CardBinder()
        ...
        metric = AverageTurnCastMetric(binder, GameId.MTG, "MSH", "PremierDraft", output_path)
    ...
    def test_default_output_path(self) -> None:
        expected = (
            AverageTurnCastMetric.DEFAULT_OUTPUT_DIR / "MSH.PremierDraft.average_turn_cast.jsonl"
        )
        assert AverageTurnCastMetric.default_output_path("MSH", "PremierDraft") == expected
