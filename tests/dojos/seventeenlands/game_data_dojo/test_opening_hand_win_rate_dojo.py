...
from src.dojos.seventeenlands.game_data_dojo.opening_hand_win_rate_dojo import (
...
# game_data_dojo's OpeningHandWinRateDojo only wires MetricRegressionDojo's
# generic constructor to game_data_metrics' own OpeningHandWinRateMetric —
...
# defaulting (against the game_data_metrics MetricScanner, not
# replay_data_dojo's own same-named but distinct dojo), plus a smoke
# test that the wired-up dojo still satisfies the Dojo contract end to
# end.
