...
from src.dojos.seventeenlands.game_data_dojo.win_rate_dojo import WinRateDojo
from src.schema.card import GenericCard, Provenance
from src.schema.data_source import DataSource
from src.schema.game_id import GameId

# WinRateDojo only wires MetricRegressionDojo's generic constructor to
# this one metric — its split/cursor/loss mechanics are already covered
# by tests/dojos/seventeenlands/test_metric_regression_dojo.py. These
# tests only cover what's actually new here: metric_name/metrics_path/
# loss defaulting, plus a smoke test that the wired-up dojo still
# satisfies the Dojo contract end to end.
...
class TestInit:
    def test_defaults_metric_name_to_the_metric_class_own_name(self, tmp_path: Path) -> None:
        ...
        assert dojo._metric_name == WinRateMetric.name
