...
from src.dojos.seventeenlands.game_data_dojo.average_game_length_with_card_dojo import (
    AverageGameLengthWithCardDojo,
)
from src.schema.card import GenericCard, Provenance
from src.schema.data_source import DataSource
from src.schema.game_id import GameId

# AverageGameLengthWithCardDojo only wires MetricRegressionDojo's generic
...
class TestInit:
    def test_defaults_metric_name_to_the_metric_class_own_name(self, tmp_path: Path) -> None:
        ...
        assert dojo._metric_name == AverageGameLengthWithCardMetric.name
