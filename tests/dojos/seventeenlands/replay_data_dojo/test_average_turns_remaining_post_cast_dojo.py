...
from src.dojos.seventeenlands.replay_data_dojo.average_turns_remaining_post_cast_dojo import (
    AverageTurnsRemainingPostCastDojo,
)
from src.schema.card import GenericCard, Provenance
from src.schema.data_source import DataSource
from src.schema.game_id import GameId

# AverageTurnsRemainingPostCastDojo only wires MetricRegressionDojo's
# generic constructor to this one metric — its split/cursor/loss
...
# defaulting, plus a smoke test that the wired-up dojo still satisfies
# the Dojo contract end to end.
...
class TestInit:
    def test_defaults_metric_name_to_the_metric_class_own_name(self, tmp_path: Path) -> None:
        ...
        assert dojo._metric_name == AverageTurnsRemainingPostCastMetric.name
