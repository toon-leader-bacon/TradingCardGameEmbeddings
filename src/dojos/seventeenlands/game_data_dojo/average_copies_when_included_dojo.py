"""Thin MetricRegressionDojo wrapper for AverageCopiesWhenIncludedMetric
(game_data_metrics).
...
from src.data_refinement.seventeenlands.game_data_metrics.metrics.average_copies_when_included import (  # noqa: E501 -- module path is one unbreakable dotted identifier
...
class AverageCopiesWhenIncludedDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its average_copies_when_included.
    ...
    fixes metric_name to AverageCopiesWhenIncludedMetric.name (never a
    ...
    def __init__(
        ...
        average_copies_when_included values.
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read
                average_copies_when_included rows from. Defaults to
        ...
        Example:
            >>> dojo = AverageCopiesWhenIncludedDojo(
            ...     expansion="MSH",
        ...
        super().__init__(
            ...
            metric_name=AverageCopiesWhenIncludedMetric.name,
