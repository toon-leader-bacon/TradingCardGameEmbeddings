"""Thin MetricRegressionDojo wrapper for DrawnWinRateMetric (game_data_metrics).
...
class DrawnWinRateDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its drawn_win_rate.
    ...
    fixes metric_name to DrawnWinRateMetric.name (never a re-declared
    ...
    def __init__(
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read drawn_win_rate
