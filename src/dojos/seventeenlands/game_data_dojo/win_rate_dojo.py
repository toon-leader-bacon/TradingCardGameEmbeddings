"""Thin MetricRegressionDojo wrapper for WinRateMetric (game_data_metrics).
...
class WinRateDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its win_rate.
    ...
    fixes metric_name to WinRateMetric.name (never a re-declared string
    literal — this pairing can't drift) and resolves a default
    ...
    def __init__(
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read win_rate rows
                from. Defaults to MetricScanner.default_output_path(
        ...
        super().__init__(
            ...
            metric_name=WinRateMetric.name,
