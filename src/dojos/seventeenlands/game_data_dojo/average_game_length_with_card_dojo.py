"""Thin MetricRegressionDojo wrapper for AverageGameLengthWithCardMetric
(game_data_metrics).
...
from src.data_refinement.seventeenlands.game_data_metrics.metrics.average_game_length_with_card import (  # noqa: E501 -- module path is one unbreakable dotted identifier
...
class AverageGameLengthWithCardDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its average_game_length_with_card.
    ...
    fixes metric_name to AverageGameLengthWithCardMetric.name (never a
    ...
    def __init__(
        ...
        average_game_length_with_card values.
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read
                average_game_length_with_card rows from. Defaults to
        ...
        Example:
            >>> dojo = AverageGameLengthWithCardDojo(
            ...     expansion="MSH",
        ...
        super().__init__(
            ...
            metric_name=AverageGameLengthWithCardMetric.name,
