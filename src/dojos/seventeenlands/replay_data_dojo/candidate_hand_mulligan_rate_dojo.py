"""Thin MetricRegressionDojo wrapper for CandidateHandMulliganRateMetric
(replay_data_metrics).
...
from src.data_refinement.seventeenlands.replay_data_metrics.metrics.binary_trigger_rate.candidate_hand_mulligan_rate import (  # noqa: E501 -- module path is one unbreakable dotted identifier
    CandidateHandMulliganRateMetric,
)
...
class CandidateHandMulliganRateDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its candidate_hand_mulligan_rate.
    ...
    fixes metric_name to CandidateHandMulliganRateMetric.name (never a
    ...
    def __init__(
        ...
        candidate_hand_mulligan_rate values.
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read
                candidate_hand_mulligan_rate rows from. Defaults to
        ...
        Example:
            >>> dojo = CandidateHandMulliganRateDojo(
            ...     expansion="MSH",
        ...
        super().__init__(
            ...
            metric_name=CandidateHandMulliganRateMetric.name,
