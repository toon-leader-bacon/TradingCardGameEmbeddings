"""Thin MetricRegressionDojo wrapper for OpponentResponseRateMetric
(replay_data_metrics).
...
from src.data_refinement.seventeenlands.replay_data_metrics.metrics.opponent_response_rate import (
...
class OpponentResponseRateDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its opponent_response_rate.
    ...
    fixes metric_name to OpponentResponseRateMetric.name (never a
    ...
    def __init__(
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read
                opponent_response_rate rows from. Defaults to
        ...
        super().__init__(
            ...
            metric_name=OpponentResponseRateMetric.name,
