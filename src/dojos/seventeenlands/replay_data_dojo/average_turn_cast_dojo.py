"""Thin MetricRegressionDojo wrapper for AverageTurnCastMetric
(replay_data_metrics).
...
from src.data_refinement.seventeenlands.replay_data_metrics.metrics.cast_event_average.average_turn_cast import (  # noqa: E501 -- module path is one unbreakable dotted identifier
...
class AverageTurnCastDojo(MetricRegressionDojo):
    """Regresses a card's embedding against its average_turn_cast.
    ...
    fixes metric_name to AverageTurnCastMetric.name (never a
    ...
    def __init__(
        ...
        Inputs:
            ...
            metrics_path: which parquet file to read average_turn_cast
                rows from. Defaults to
        ...
        super().__init__(
            ...
            metric_name=AverageTurnCastMetric.name,
