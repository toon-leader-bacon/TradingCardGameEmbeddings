"""Generic dojo for the (two card groups in, scalar regression out) task shape.
...
class MultiGroupRegressionDojo(GenericDojo):
    """Dojo for the (two card groups in, scalar regression out) task shape.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            holdout=holdout,
            decoder_head=MultiGroupRegressionDecoderHead(
